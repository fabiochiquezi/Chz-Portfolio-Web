...
const slideshowMessage = 'lg:text-2xl px-4 md:px-16 lg:px-12 xl:px-32 pt-2 md:pt-7 md:text-lg text-center m-auto mb-8 lg:font-light text-gray-500 leading-7 lg:leading-10'
const slide = 'flex flex-col items-center text-center'
const slideshowWrapper = 'flex flex-col items-center lg:mt-24 xl:mt-16 mt-20 md:flex-row md:gap-10 w-full justify-center xl:w-5/6 xl:mx-auto'
...
const Testimonial2: React.FC<props> = ({ slides, images, className, title, ...props }) => {
    const settings = {
        dots: false,
        infinite: true,
        speed: 600,
      ...
      return (
          <Section className={className ?? section} {...props}>
              <div className="container">
                    ...
                    <Title3 title={title} data-aos="fade-up" data-aos-delay="200" className="mb-4" />
                    ...
                    >Ver Comentários no Google</a>

                    <div
                        data-aos="fade"
                        className="px-8 md:px-16 lg:w-5/6 mx-auto"
                    >
                        <Slider {...settings}>
                            {slides.map((el, index) => (
