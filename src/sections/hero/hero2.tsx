...
const h1 = 'text-4xl lg:text-6xl xl:text-6xl 2xl:text-7xl font-bold mb-1 lg:mb-2 2xl:mb-0 text-white'
...
const container = 'container flex flex-col items-center md:flex-row lg:items-start'

const wrapImg = 'w-100 md:w-1/2 flex justify-end xl:w-auto order-1 md:order-2 mb-12 md:mb-0'
const img = 'w-72 md:w-96 lg:w-auto xl:w-9/12 md:mr-16 lg:mr-0 xl:mr-16 xl:mt-5 2xl:mr-20'
...
const Hero2: React.FC<props> = ({ name, position, block1, block2, image, className }) => {
    return (
        <section style={{ background: colors.black1 }} className={className ?? section}>
                ...
                <div className="md:w-1/2 order-2 md:order-1 lg:pt-2 xl:w-3/6">
                    ...
                    <div data-aos="fade" data-aos-delay="300">
                        ...
                        <div className="md:w-1/2 lg:w-5/6 xl:w-full">
                            ...
                            <p className={messages + ' mb-4 lg:mb-4 text-white' }>
                                {block2.address}<br /> {block2.email} <br />{block2.phone}
                            </p>
