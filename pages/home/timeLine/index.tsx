...
import Btn2 from '../../share/components/buttons/btn2'
import Title3 from '../../share/components/titles/title3'
...
const Section = styled.section<sectionProps>`
    background: ${props =>
        props.mode === 'light' ? colors.white1 : colors.black1};
`
        ...
        <Section className={className} mode={mode}>
            <div className="container relative">
                ...
                <div className="content flex flex-col items-center w-full">
                    <Line
                        className="line hidden md:inline-block"
                        extraHeight={linkSeeMore ? 155 : 0}
                        height={times.length}
                        data-aos="fade-up"
                    ></Line>
                    ...
                    <p
                        className={
                            'mb-6 lg:mb-8 2xl:mb-10 lg:mt-10 z-10 md:py-4 w-xs text-xl 2xl:text-2xl max-w-sm lg:max-w-md text-center' +
                            (mode === 'dark'
                                ? ' bg-neutral1 text-white'
                                : ' bg-white text-black')
                        }
                        data-aos="fade-up"
                        data-aos-delay="50"
